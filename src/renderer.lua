    ...
    if Settings.get().scan_items then
        for _, item in pairs(actors_manager:get_all_items()) do
            ...
            if info then
                ...
                local highlight = skin:find("Charm") or skin:find("Flippy") or skin:find("Set") or skin:find("Horadric") or skin:find("[Kk]ey") or skin:find("[Oo]re") or skin:find("Trinket") or skin:find("Seal") or skin:find("Talisman") or skin:find("Boss") or skin:find("PowerUp") or skin:find("Tribute") or skin:find("Treasure") or skin:find("Cache")
